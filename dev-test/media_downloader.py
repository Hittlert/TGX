...
async def _start_runtime(client):
    """Start the client and publish its process-wide media session pool."""
...
async def _shutdown_runtime(client, tasks, pool, stop_bot=None) -> None:
    """Stop runtime work before closing its pool and Telegram client."""
...
def main():
    ...
    try:
        ...
        pool = app.loop.run_until_complete(_start_runtime(client))
        ...
        app.loop.run_until_complete(
            _shutdown_runtime(client, tasks, pool, bot_stopper)
        )
